  ...
  useEffect(() => {
    ...
    const drawHead = (o: Obstacle, gy: number) => {
      ...
      if (v === 3) {
        ...
        drawPixelRect(x + 16, y0 + 13, o.w - 32, 3, "#3A2B2B");
        drawPixelRect(x + 7, y0 + 11, 7, 8, "#9db8c9");
